...
library(dplyr)
setwd("..\\Zillow")
properties<-fread("..\\Zillow\\properties_2016.csv")
sample<-fread("..\\Zillow\\sample_submission.csv")
transactions<-fread("..\\Zillow\\train_2016.csv")
...
transactions<-transactions%>%rename(id_parcel=parcelid)
